#ifndef MAE3_ENCODER3_H
#define MAE3_ENCODER3_H
...
{
public:
    MAE3Encoder3(uint8_t signalPin, uint8_t interruptPin, uint8_t encoderId,
...
private:
    ...
    static MAE3Encoder3* encoderInstances[MAX_ENCODERS];
};

#endif  // MAE3_ENCODER3_H